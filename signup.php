...
<?php
	...
	//$sql = "DELETE FROM Users WHERE email='galap@uwindsor.ca'";
	//$conn->query($sql);
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      if (empty($email) or empty($pwd) or empty($fname) or empty($lname)) {
        ...
        if ($result->num_rows > 0) {
          echo "User already registered! Please log in to your account.";
          header("Location: https://galap.myweb.cs.uwindsor.ca/COMP-2707-W23/project/login.php");
        }
        else {
          $sql = "INSERT INTO Users (email,password,fname,lname) VALUES ('$email','$pwd','$fname','$lname')";
          $conn->query($sql);
