      ...
      if (empty($email) or empty($pwd)) {
        ...
        if ($result->num_rows > 0) {
          ...
          if ($row["email"]==$email and $row["password"]==$pwd) {
            ...
            header("Location: https://galap.myweb.cs.uwindsor.ca/COMP-2707-W23/project/index.html");
          }
          else {
            ...
            echo "Account not found. Sign up to create a new account.";
            header("Location: https://galap.myweb.cs.uwindsor.ca/COMP-2707-W23/project/signup.php");
          }
      }
    }
?>